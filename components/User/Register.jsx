...
const Register = () => {
    ...
    return (
        <>
            <MetaData title="Register | CortexLab E-Commerce" />
                    ...
                    <div className="flex-1 overflow-hidden">
                        ...
                        >
                            <div className="flex flex-col gap-4 items-start">
                                ...
                                <Link href="/login" className="hover:bg-gray-50 text-primary-blue text-center py-3 w-full shadow border rounded-sm font-medium">Existing User? Log in</Link>
                            </div>
