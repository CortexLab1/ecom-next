...
const UpdatePassword = () => {
    ...
    return (
        <>
            <MetaData title="Password Update | CortexLab E-Commerce" />
                    ...
                    <div className="flex-1 overflow-hidden">
                        ...
                        >
                            <div className="flex flex-col gap-4 items-start">
                                ...
                                <Link className="hover:bg-gray-50 text-primary-blue text-center py-3 w-full shadow border rounded-sm font-medium mb-8" href="/account">Cancel</Link>
                            </div>
