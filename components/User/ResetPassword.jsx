...
const ResetPassword = () => {
    ...
    return (
        <>
            <MetaData title="Password Reset | CortexLab E-Commerce" />
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div class="flex flex-col w-full gap-4">
                                    ...
                                    <div class="flex flex-col gap-2.5 mt-2 mb-32">
                                        <p class="text-xs text-primary-grey text-left">By continuing, you agree to CortexLab E-Commerce's <a href="/pages/terms" class="text-primary-blue"> Terms of Use</a> and <a href="/pages/privacypolicy" class="text-primary-blue"> Privacy Policy.</a></p>
