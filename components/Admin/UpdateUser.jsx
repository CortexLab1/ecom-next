...
const UpdateUser = () => {
    ...
    return (
        <>
            <MetaData title="Admin: Update User | CortexLab E-Commerce" />
                    ...
                    <div className="flex flex-col bg-white shadow-lg rounded-lg mx-auto w-lg max-w-xl">
                        ...
                        >
                            <div className="flex flex-col gap-3 items-start">
                                ...
                                <Link className="hover:bg-gray-100 text-primary-blue text-center py-3 w-full shadow border rounded-sm font-medium" href="/admin/users">Cancel</Link>
                            </div>
